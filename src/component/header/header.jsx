...
export default function Header() {
  ...
  return (
    <>
      <div className="h-20 bg-slate-100 align-middle flex flex-col justify-center items-center relative">
        <h1 className="  font-bold md:text-3xl text-xl ">Money Management</h1>
        <h4 className="font-bold  leading-5 md:text-lg opacity-70 mt-1">(buy without interest)</h4>
